...
class Produksi():
    ...
    def inferensi(self, jumlah_permintaan, jumlah_persediaan):
        ...
        z4 = self.tambah(α4)
        result.append((α4, z4))
        # [R5] JIKA permintaan turun, dan persediaan banyak, MAKA
        # produksi barang berkurang.
        α5 = min(pmt.turun(jumlah_permintaan), psd.banyak(jumlah_persediaan))
        z5 = self.kurang(α5)
        result.append((α5, z5))
        # [R10] JIKA permintaan turun, dan persediaan banyak, MAKA
        # produksi barang bertambah.
        α6 = min(pmt.turun(jumlah_permintaan), psd.banyak(jumlah_persediaan))
        z6 = self.tambah(α6)
        result.append((α6, z6))
        # [R7] JIKA permintaan naik, dan persediaan cukup, MAKA
        # produksi barang bertambah.
        α7 = min(pmt.naik(jumlah_permintaan), psd.cukup(jumlah_persediaan))
        z7 = self.tambah(α7)
        result.append((α7, z7))
        # [R8] JIKA permintaan turun, dan persediaan cukup, MAKA
        # produksi barang berkurang.
        α8 = min(pmt.turun(jumlah_permintaan), psd.cukup(jumlah_persediaan))
        z8 = self.kurang(α8)
        result.append((α8, z8))
        # [R9] JIKA permintaan turun, dan persediaan tidak cukup, MAKA
        # produksi barang bertambah.
        α9 = min(pmt.turun(jumlah_permintaan), psd.tidak_cukup(jumlah_persediaan))
        z9 = self.tambah(α9)
        result.append((α9, z9))
        # [R10] JIKA permintaan naik, dan persediaan tidak cukup, MAKA
        # produksi barang bertambah.
        α10 = min(pmt.naik(jumlah_permintaan), psd.tidak_cukup(jumlah_persediaan))
        z10 = self.tambah(α10)
